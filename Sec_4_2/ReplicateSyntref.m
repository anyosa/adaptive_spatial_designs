function [scorevecADAPT,scorevecP,scorevecSPAT]=ReplicateSyntref;
...
% Prior model
[sig,nu,ksi,mubeta,Sigmabeta,gamma]=sethyperparSYNTref;
...
% Spatial covariance matrix :toeplitz (see separate file below)
...
for bb=1:B,
    ...
    % Print to file
    % Not needed if stored before and re-read parameters
    fileID=fopen(sprintf('ReplicREF%d.csv',bb),'w');
